...
### Schaltfläche 'nächste Aufgabe' anzeigen
...
### Automatische Prüfung der Abfrage
...
Die Tabelle und die Spalte können auch weggelassen werden, wenn man nur Werte im Ergebnis ablgeichen will, unabhängig von der Tabelle bzw. Spalte:
...
<center>
<img className='customImageBorder'
  src={require('../assets/aufgaben6.png').default} 
/>
</center>