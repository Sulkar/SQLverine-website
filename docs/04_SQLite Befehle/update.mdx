...
<CustomEditorLink
  fontSize="2em"
  border="0px"
  sqlQuery="UPDATE/s tabelle/t SET/s spalte/c =/s 'neuerWert'/i"
></CustomEditorLink>
...
<CustomEditorLink
  fontSize=""
  border=""
  sqlQuery="UPDATE/s tabellenname/t SET/s spaltenname/c =/s <neuerWert>/i"
></CustomEditorLink>
oder
<CustomEditorLink
  fontSize=""
  border=""
  sqlQuery="UPDATE/s tabellenname/t SET/s spaltenname/c =/s <neuerWert>/i /n WHERE/s spaltenname/c <Operator>/o <Wert>/i" 
></CustomEditorLink>
